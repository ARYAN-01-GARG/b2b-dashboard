...
function BiLineCard({ title, yLabel, data }: LineCardProps) {
	return (
			...
			<div className="h-64">
				<ResponsiveContainer width="100%" height="100%">
					<LineChart data={data} margin={{ top: 8, right: 16, left: 0, bottom: 24 }} className="cursor-pointer">
						...
						<Line type="monotone" dataKey="value" stroke="#28A745" strokeWidth={3} dot={{ r: 4, stroke: "#28A745", strokeWidth: 2, fill: "#28A745" }} activeDot={{ r: 6 }} />
						<Line type="monotone" dataKey="value" stroke="#333" strokeWidth={3} dot={{ r: 4, stroke: "#333333", strokeWidth: 2, fill: "#ffffff" }} activeDot={{ r: 6 }} />
					</LineChart>
				</ResponsiveContainer>
			</div>
		</div>
